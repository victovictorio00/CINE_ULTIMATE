...
<head>
    ...
    <link rel="stylesheet" href="<%= request.getContextPath()%>/Estilos/dulceriaStyle.css">
    
    <style>
        .resumen-compra {
            background: linear-gradient(180deg, #282828 0%, #3a3a3a 50%, #282828 100%);
        ...
        .resumen-compra h4 {
            ...
            border-bottom: 1px solid rgba(255,255,255,0.1); /* Nueva línea */
            padding-bottom: 10px;
            color: #f9a825;
        }
        
        .resumen-compra .info-item {
            display: flex;
            justify-content: space-between;
            padding: 10px 0; /* Aumentado padding vertical */
            /* Divisor más suave */
            border-bottom: 1px solid rgba(255,255,255,0.08);
        }
        
        .resumen-compra .info-item:last-child {
            border-bottom: none;
            font-size: 1.3em; /* Más grande */
            font-weight: bold;
            margin-top: 15px;
            color: #ffab40; /* Color resaltado para el total */
        }
...
<body style="background-color: var(--main-bg, #1e1e1e);">
    ...
    <div class="container py-4">
        ...
        <%-- RESUMEN DE COMPRA (solo si está en flujo de compra) --%>
        <% if (esFlujoDeCompra) { %>
        ...
        <% } else { %>
        <%-- Modo catálogo (sin compra activa) --%>
    ...
    <%-- BOTÓN FLOTANTE (solo en flujo de compra) --%>
    <% if (esFlujoDeCompra) { %>
    ...
    <script>
        ...
        /**
         * Actualiza el botón flotante con el total
         */
        ...
        /**
         * Envía el carrito al servlet en formato compatible
         */
